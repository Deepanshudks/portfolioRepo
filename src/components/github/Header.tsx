    ...
    <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <RiSparklingFill className="w-4 h-4 text-teal-400 absolute -top-1 -right-1 animate-bounce" />
        </div>
        <div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="px-6 py-2.5 bg-teal-500/10 hover:bg-teal-500/20 border border-teal-500/30 hover:border-teal-500/50 rounded-xl text-teal-400 hover:text-teal-300 font-medium transition-all flex items-center gap-2 group"
      >
