...
const PlayerCard: React.FC<PlayerCardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-3xl p-6 md:p-8 shadow-2xl border border-neutral-700 mb-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-teal-400/10 rounded-full blur-3xl animate-pulse delay-75"></div>

      <div className="relative z-10 grid md:grid-cols-2 gap-8">
        {/* Album Art */}
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-teal-400 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
          <img
            src={
