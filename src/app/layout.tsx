...
export const metadata: Metadata = {
  ...
  title: {
    default: "Kuldeep Gaud | Full Stack Developer",
    template: "%s | Kuldeep Gaud",
  },
  description:
  ...
  authors: [{ name: "Kuldeep Gaud", url: "https://hrshkshri.me" }],
  creator: "Kuldeep Gaud",
  publisher: "Kuldeep Gaud",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    siteName: "Kuldeep Gaud Portfolio",
    title: "Kuldeep Gaud | Full Stack Developer",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kuldeep Gaud - Full Stack Developer",
        type: "image/png",
      },
    ],
    profile: {
