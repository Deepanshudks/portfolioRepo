            ...
            <div className="flex space-x-1 items-center">
                <div className="flex flex-col">
                    <h2 className="text-4xl text-neutral-400 font-medium font-sans">
                        Hi, I'm{" "}
                        <span className="text-6xl font-bold text-teal-400 drop-shadow-lg shadow-neutral-100 font-serif">
                            Kuldeep
                        </span>
                        .
                    </h2>
                    <h1 className="lg:text-9xl min-[320px]:max-lg:text-8xl  text-teal-200 font-bold font-Rampart ">
                        I Code.
                    </h1>
                </div>
                <Image
