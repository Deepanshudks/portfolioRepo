        ...
        <div className="w-full">
            ...
            <div className="mt-5">
                {projectsData.slice().map((project, index) => (
                    <div key={index} className="border-l-2 pl-1 transition ease-in-out duration-300 hover:border-teal-500">
                        <div className="group relative mb-8 p-4 transition duration-300 ease-in-out">
                            ...
                            <div className="text-neutral-500">
                                ...
                                <div className="mt-4 flex items-center space-x-1">
                                    <p className="font-semibold group-hover:text-teal-500 transition ease-in-out duration-300">
                                        Category:
                                    </p>
